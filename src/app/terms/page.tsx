      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 font-body text-sm text-noir-300 leading-relaxed">
          <section>
            ...
            <p className="mb-2">1.1 This agreement is entered into between you (hereinafter referred to as the "User") and the operator of LightCraft regarding the use of the Platform's services.</p>
          ...
          <section>
            ...
            <p className="mb-2">4.1 The Platform uses a credit-based billing system. Newly registered users receive 50 credits for trial use, with a trial period of 7 days from registration.</p>
          ...
          <section>
            ...
            <p className="mb-2">5.1 Users activate membership services by contacting support. The Platform does not have automatic billing or auto-renewal mechanisms.</p>
            <p className="mb-2">5.2 Membership services are billed monthly. Users must proactively contact support each month to renew.</p>
          ...
          <section>
            ...
            <p>11.2 If you have any questions about this agreement, please contact us through the "Contact Support" feature within the Platform.</p>
          </section>
        </div>
      </main>
    </div>
